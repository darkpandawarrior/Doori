package com.mileway.feature.logging.search
            ...
            .forEach {
                results +=
                    SearchResult(
                        ...
                        deeplink = "mileway://log/expense/${it.id}",
                    )
            }
            ...
            .forEach {
                results +=
                    SearchResult(
                        ...
                        deeplink = "mileway://log/voucher/${it.id}",
                    )
            }
            ...
            .forEach {
                results +=
                    SearchResult(
                        ...
                        deeplink = "mileway://log/settlement/${it.id}",
                    )
            }
            ...
            .forEach {
                results +=
                    SearchResult(
                        ...
                        deeplink = "mileway://log/cardtxn/${it.id}",
                    )
            }
