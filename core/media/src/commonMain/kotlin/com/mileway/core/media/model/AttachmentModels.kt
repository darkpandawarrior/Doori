 ...
 *
 * Moved here from `feature:media` (V25 P25.A1.1) so every consumer — capture UI, forms, expense
 * attachment pickers — can reach [AttachmentItem] and friends without depending on feature:media.
 * `feature:media` re-exports these via typealias so its existing imports keep compiling.
 */
