...
val coreDataModule =
    module {
        ...
        single<kotlinx.coroutines.flow.StateFlow<Boolean>>(
            org.koin.core.qualifier
                .named("reverseGeocodeRemote"),
        ) {
            get<PluginRegistry>()
                .observe("reverse_geocode_remote")
                .stateIn(
        ...
        single<CredentialSource> { CredentialStore(androidContext()) }
