...
class FakeNetworkApiTest {
    ...
    @Test
    fun `vehicles returns non-empty list`() =
        runTest {
    ...
    @Test
    fun `logMilesServices returns non-empty services`() =
        runTest {
    ...
    @Test
    fun `submitMiles returns success status`() =
        runTest {
            val result =
                api.submitMiles(
    ...
    @Test
    fun `logMiles reimbursable amount equals distance times rate`() =
        runTest {
            val result =
                api.logMiles(
    ...
    @Test
    fun `distance calculates haversine for two valid coords`() =
        runTest {
            val result =
                api.distance(
                    DistanceRequestV2(
    ...
    @Test
    fun `distance with single coord returns zero`() =
        runTest {
    ...
    @Test
    fun `submitMilesEvent and discardMiles are no-ops`() =
        runTest {
    ...
    @Test
    fun `fetchMap returns correct lat lng`() =
        runTest {
