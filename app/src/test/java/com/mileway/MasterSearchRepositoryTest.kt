...
class MasterSearchRepositoryTest {
    ...
    @Test
    fun `short queries never hit a provider`() =
        runTest {
    ...
    @Test
    fun `fans out across providers and merges`() =
        runTest {
            val repo =
    ...
    @Test
    fun `de-duplicates identical type and id across providers`() =
        runTest {
    ...
    @Test
    fun `orders exact title match first then by recency`() =
        runTest {
            val repo =
                MasterSearchRepository(
                    listOf(
    ...
    @Test
    fun `type filter skips providers that serve none of the requested types`() =
        runTest {
    ...
    @Test
    fun `a failing provider does not sink the whole search`() =
        runTest {
            val repo =
                MasterSearchRepository(
                    listOf(
    ...
    @Test
    fun `a failing provider's types surface in failedTypes for a retry affordance`() =
        runTest {
            val repo =
                MasterSearchRepository(
                    listOf(
    ...
    @Test
    fun `a healthy search reports no failed types`() =
        runTest {
