...
val appModule =
    module {
        ...
        single<com.mileway.core.platform.DeepLinkHandler> {
        ...
        single<com.siddharth.kmp.appshell.PushTokenStore> {
            com.siddharth.kmp.appshell
                .InMemoryPushTokenStore()
        }
        single<com.siddharth.kmp.appshell.PushMessaging> {
            com.siddharth.kmp.appshell
                .LocalPushMessaging(get())
        }
        ...
        single<com.mileway.core.platform.ReferralStore> {
            com.mileway.core.platform
                .InMemoryReferralStore()
        }
        single {
            com.mileway.core.platform
                .LocalReferralManager(get())
        }
        ...
        single {
            com.mileway.core.data.search
                .MasterSearchRepository(getAll<com.mileway.core.data.search.SearchProvider>())
        }
        viewModel {
            com.mileway.ui.search
                .MasterSearchViewModel(get())
        }
    }

class MilewayApplication :
    Application(),
    ...
    private fun seedAppShortcuts() {
        get<com.mileway.core.platform.AppShortcuts>().setDynamicShortcuts(
            listOf(
                com.mileway.core.platform
                    .AppShortcut("track", "Track", "Track a trip", "mileway://track"),
                com.mileway.core.platform
                    .AppShortcut("log", "Log miles", "Log miles & expenses", "mileway://log"),
                com.mileway.core.platform
                    .AppShortcut("profile", "Profile", "Open your profile", "mileway://profile"),
            ),
        )
    }
