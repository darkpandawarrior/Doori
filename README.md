...
<!-- AUTOGEN:stats -->
> **At a glance** — **46-module** clean architecture: **36 local** (13 feature · 12 core) + **10 composed** via `includeBuild(external/kmp-toolkit)`, Room schema **v48**, **326** host-rendered Roborazzi screenshots (JVM, no emulator). *Numbers auto-generated from `settings.gradle.kts` by `scripts/gen-readme.sh`.*
<!-- /AUTOGEN:stats -->
